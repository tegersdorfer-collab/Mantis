...
TTS_KOKORO_VOICE         = cfg.TTS_KOKORO_VOICE
STT_ENGINE               = cfg.STT_ENGINE
STT_PARAKEET_MODEL       = cfg.STT_PARAKEET_MODEL
...
LOCAL_LOGITS_ENABLED     = cfg.LOCAL_LOGITS_ENABLED
LOCAL_LOGITS_TIMEOUT_S   = cfg.LOCAL_LOGITS_TIMEOUT_S
...
AUTONOMOUS_MESSAGES_ENABLED = cfg.AUTONOMOUS_MESSAGES_ENABLED
