...
def _review_prompt(task: dict, kontext: dict) -> str:
    return (
        ...
        "Du darfst Dateien im Arbeitsbereich lesen, um Erwartungen und Aufrufe "
        "gegen den echten Code zu prüfen. Du hast keine Shell und kannst keine "
        "Tests laufen lassen — urteile aus Diff und Quellen. Was du so nicht "
        "verifizieren kannst, nennst du als Befund mit passender Schwere, statt "
        "es zu versuchen oder ohne Urteil abzubrechen.\n"
